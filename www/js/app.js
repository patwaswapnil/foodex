...
var domain = 'http://pethjinni.cruxservers.in/';
var imgPath = 'http://pethjinni.com/';
angular.module('foodex', ['ionic', 'ionic.service.core', 'ngCordova', 'foodex.controllers', 'foodex.services', 'ion-autocomplete', 'ngCordovaOauth', 'ionic.service.analytics'])
    .run(function ($ionicPlatform, $cordovaStatusbar, $ionicAnalytics, $rootScope, $ionicHistory) {
        ...
        $rootScope.$on('$stateChangeStart', function (event, toState, toParams, fromState, fromParams) {
            if (toState.name == 'app.location' || toState.name == 'app.home') {
